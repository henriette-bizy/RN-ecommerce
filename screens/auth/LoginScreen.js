const { StyleSheet, Image, Text, View, StatusBar, KeyboardAvoidingView, ScrollView } = require('react-native');
const React = require('react');
const { useState } = React;
const { colors, network } = require('../../constants');
const CustomInput = require('../../components/CustomInput');
const header_logo = require('../../assets/logo/logo.png');
const CustomButton = require('../../components/CustomButton');
const CustomAlert = require('../../components/CustomAlert/CustomAlert');
const ProgressDialog = require('react-native-progress-dialog');
const InternetConnectionAlert = require('react-native-internet-connection-alert');
